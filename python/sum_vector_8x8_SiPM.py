...
class AnalyticalMethodSolution:
    ...
    def __init__(self):
        ...
        data_folder = Path("/home/konstantinos/Desktop/diplomatiki/data_files_txt/gauss_dist/realistic/Co_60/")
        ...
        #df_Calculated_Energy = self.calculateEnergy()   falseeee
        
        #df_sum is 1-D and has Total counts of all events
        global df_sum
        df_sum = self.df_bottom_layer.sum(axis=0).to_frame()
        print(df_sum)
    ...
    def calculateEnergy(self):
        ...
        #ax3 holds spectrum between [LBE-HBE] keV
        hist = df_Calculated_Energy.hist(bins = 100,  edgecolor="blue",color='white',ax = ax3)
