...
class Co57_isotope:
    ...
    class Co57_AnalyticalMethodSolution_8x8_SiPM:
        ...
        def __init__(self):
            ...
            self.final_list_Δφ = []
            #user sets the path and .txt file
            self.data_folder = Path("/home/konstantinos/Desktop/diplomatiki/main_code/Co_57_Folder/realistic_geometry_detectors/Co57_8x8_SiPM_3600_events/Co57_8x8_SiPM_3600_events_txt/")
...
obj = Co57_isotope()
obj.Co57_DataAnalysis_8x8_SiPM()
