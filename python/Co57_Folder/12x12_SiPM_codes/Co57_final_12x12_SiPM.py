...
class AnalyticalMethodSolution:
    ...
    def __init__(self):
        ...
        self.data_folder = Path("/home/konstantinos/Desktop/diplomatiki/main_code/Co_57_Folder/realistic_geometry_detectors/12x12_SiPM_10000_events/10000_event_12x12_txt/")
...
class DataAnalysis:
    ...
    def gaussian_plot_distribution(self):
        ...
        mean2 = np.mean(Co57_9700_events_btin_110_140kev)
        ...
        variance2 = np.var(Co57_9700_events_btin_110_140kev)
        ...
        LSL2 = min(Co57_9700_events_btin_110_140kev)
        USL2 = max(Co57_9700_events_btin_110_140kev)
        
        LSL3 = min(Co57_9700_events_btin_110_140kev)
        USL3 = max(Co57_9700_events_btin_110_140kev)
        ...
        #seting ax2 plot
        n, bins_ax2, patches = ax2.hist(Co57_9700_events_btin_110_140kev, bins = num_bins, range=(-200,200),density=True,  edgecolor="blue",color='white')
        # add a 'best fit' line 
        ...
        #seting ax3 plot
        n, bins_ax3, patches = ax3.hist(Co57_9700_events_btin_110_140kev, bins = num_bins, range=(-200,200),density=True,  edgecolor="blue",color='white')
        # add a 'best fit' line 
