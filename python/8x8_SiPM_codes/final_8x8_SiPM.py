...
class DataAnalysis:
    ...
    def gaussian_plot_distribution(self):
        ...
        #define constants
        mean = np.mean(Co60_11000_events_btin_1150_1350kev)
        variance = np.var(Co60_11000_events_btin_1150_1350kev)
        sigma = np.sqrt(variance)
        mean_of_events = np.mean(11000)
        
        LSL = min(Co60_11000_events_btin_1150_1350kev)
        USL = max(Co60_11000_events_btin_1150_1350kev)
        num_bins = 80
        ...
        n, bins, patches = ax.hist(Co60_11000_events_btin_1150_1350kev, bins = num_bins, range=(-200,200),density=True,  edgecolor="blue",color='white')
    ...
    def sigma_events_relation(self):
        ...
        x_realistic_8x8_SiPM = [3500, 7500, 11000]
        y_realistic_8x8_SiPM = [17.91, 12.16, 11.09]

        # Plot a simple line chart without any feature
        plt.plot(x_realistic_8x8_SiPM, y_realistic_8x8_SiPM)
        plt.ylim(bottom=5) 
        plt.title('Co60 Source / 8x8 SiPM \n Relation Sigma - events')
