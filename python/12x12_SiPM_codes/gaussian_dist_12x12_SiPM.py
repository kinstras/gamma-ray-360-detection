...
def plot():
    ...
    #define constants
    mean = np.mean(Co60_7000_events_btin_550_1350kev)
    variance = np.var(Co60_7000_events_btin_550_1350kev)
    sigma = np.sqrt(variance)
    mean_of_events = np.mean(7000)
    
    LSL = min(Co60_7000_events_btin_550_1350kev)
    USL = max(Co60_7000_events_btin_550_1350kev)
    num_bins = 80
    ...
    n, bins, patches = ax.hist(Co60_7000_events_btin_550_1350kev, bins = num_bins, range=(-200,200),density=True,  edgecolor="blue",color='white')
